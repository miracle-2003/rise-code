...
Добро пожаловать в документацию по созданию QR-меню. RISE - это мощный инструмент для создания меню на PHP и React JS с QR-кодом. Он отличается креативным дополнением совершенного дизайна и выдающейся функциональности.

# Преимущества электронного меню RISE

Главное: это не только электронное меню, но и интернет-магазин для ваших гостей. Гости, воспользовавшиеся электронным меню внутри заведения, смогут пользоваться им и после - для доставки ваших блюд и/или самовывоза. Вы же получаете не просто модную фишку, но и возможность коммуникации со своими клиентами через бесплатные push-сообщения в мессенджеры,благодаря их оцифровке. 
# 
 Еще несколько плюсов:
# 

•Меню в смартфонах и других мобильных устройствах ваших гостей

•Это не мобильное приложение, его не нужно скачивать!

•Возможность быстро «перепечатывать» электронное меню, онлайн добавляя новые позиции и расставляя «стопы»

•Минимум контактов внутри заведения

•Возможность получать оплату через электронное меню

•Возможность «оцифровать» своих гостей и использовать эти данные для маркетинговых активностей
...
<img src="http://aston.aston.fun/1.jpg"  width="300" style="max-width:100%;">
# 
